...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'subtitle' => __('Choose if you would like to use Virtue Theme SEO options, We do not recomend this as its only basic for really basic sites for full seo support use a plugin.', 'virtue'),
            "default" => 0,
            ), 
        array(
            'id'=>'seo_sitetitle',
