...
<?php 
            if ( false === $this->parent->args['hide_save'] ) {
                submit_button( __( 'Salvar Alterações', 'redux-framework' ), 'primary', 'redux_save', false );
            }

            if ( false === $this->parent->args['hide_reset'] ) {
                submit_button( __( 'Resetar Seção', 'redux-framework' ), 'secondary', $this->parent->args['opt_name'] . '[defaults-section]', false, array( 'id' => 'redux-defaults-section' ) );
                submit_button( __( 'Resetar Tudo', 'redux-framework' ), 'secondary', $this->parent->args['opt_name'] . '[defaults]', false, array( 'id' => 'redux-defaults' ) );
            } 
?>
        </div>

        <div class="redux-ajax-loading" alt="<?php _e( 'Trabalhando...', 'redux-framework' ) ?>">&nbsp;</div>
        <div class="clear"></div>
