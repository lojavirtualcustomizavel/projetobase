...
ob_start(); ?>
<div id="kad-blog-grid" class="shortcode_blog_grid_content rowtight reinit-isotope init-isotope" data-fade-in="<?php echo esc_attr($animate);?>" data-iso-selector=".b_item" data-iso-style="<?php echo esc_attr($iso_style); ?>"> 
<?php  
					if(!empty($wp_query)) {$temp = $wp_query; }
					$wp_query = null; 
					$wp_query = new WP_Query();
